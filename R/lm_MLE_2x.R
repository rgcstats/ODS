...
#' @param startpar Optional. Vector of starting parameters for optimisation. If not supplied, starting parameters are
#'                 obtained from pi-weighted regressions.
...
#' @export
lm.MLE.2x <- function(ys,x1s,x2s,p.s,specs,pi.s,pi.fn=NULL,N,R,Rquad,startpar=NULL){
  # get starting values
